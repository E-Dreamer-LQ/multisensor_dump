...
def Draw_trajectory(x0,y0,theta0,ds,rou):
    point_num, dsmin=Get_traj_point_num_ds(ds)
    ...
    if (abs(rou) < 0.01):
        for i in range(point_num-1):
            ...
            Position_arr[i][3]=(i+1) * dsmin * sign(ds);
...
def get_rxrx_from_points(pos,point_arr):
